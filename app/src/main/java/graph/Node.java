...
public class Node {
    ...
    /**
     * Return the map that associates each neighbor with the weight of the edge to that neighbor.
     */
    ...
    /**
     * Add an edge to neighbor with the given weight. If such an edge already existed, upate its weight.
     */
